...
namespace Orleans.Clustering.Kubernetes
{
    internal class KubeGatewayListProvider : IGatewayListProvider
    {
        ...
        public async Task<IList<Uri>> GetGateways()
        {
            try
            {
                var silos = (await this._kube.CustomObjects.ListNamespacedCustomObjectAsync(Constants.ORLEANS_GROUP, Constants.PROVIDER_MODEL_VERSION, this._namespace, SiloEntity.PLURAL)).ConvertCustomObjectItems<SiloEntity>();
